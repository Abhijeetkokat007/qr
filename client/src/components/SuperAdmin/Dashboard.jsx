...
import { FaBoxOpen, FaTruck, FaLayerGroup, FaCogs } from "react-icons/fa";
...
export const DashboardSuper = () => {
  const features = [
    ...
    {
      label: "Traceability",
      icon: <FaLayerGroup className="text-red-500 text-3xl" />,
      path: "/layer-traceability",
    },
    {
      label: "User Management",
      icon: <LuUserSearch className="text-lime-500 text-3xl" />,
    ...
    <div className="relative min-h-screen w-full px-4 py-8">
      ...
      <div className="text-center p-6 relative z-10">
        ...
        <p className="mb-10 text-xl font-normal mt-5 text-black">
          Welcome to Super Admin dashboard, here you can manage all the data of
          your products
        </p>
